...
export default function Create({ yourCharacter, community }) {
  ...
  return (
    <CommunityLayout yourCharacter={yourCharacter} community={community}>
      ...
      <div className="flex justify-center items-center w-full min-h-screen p-4 pb-24 xl:pb-4">
        ...
        >
          <div>
            <form className="flex flex-col xl:flex-row gap-4 relative" onSubmit={submit}>
